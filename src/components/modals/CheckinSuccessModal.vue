  ...
  >
    <div class="p-0 m-0">
      ...
      <div v-if="alsoOnThisConnection.length > 0" class="list-group">
        <router-link
          v-for="otherStatus in alsoOnThisConnection"
          v-bind:key="otherStatus.id"
          :to="{
            name: 'singleStatus',
            params: { id: otherStatus.id, statusData: otherStatus },
          }"
